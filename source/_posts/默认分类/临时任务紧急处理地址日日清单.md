...
| [公司合作伙伴管理](http://gl.fotechwealth.com.local/backend/company-partner/tree/feature/dev-ID1029143) | `done` |  |
...
| --- | --- | --- |
|   |  |  |
| [有道云笔记处理](https://note.youdao.com/) | `wait` |  |
| [devv.ai 对话记录清理](https://devv.ai/zh) | `wait` |  |
| [这些网站是找时间归档一下](https://ai-bot.cn/) | `wait` |  |
| [国内免费JS公共库、JAVASCRIPT公共库、CDN镜像库：BOOTCDN、字节跳动](https://blog.csdn.net/lishuoboy/article/details/127339143) 和[一个免费面向中国境内外的高速jsdelivr镜像站](https://github.com/54ayao/JSDMirror)和[将jsdelivr镜像源迁移到Gcore —— Gcore CDN使用](https://bili33.top/posts/Migrate-jsdelivr-mirror-to-Gcore/) | `wait` | 一些公共库前端库的CND之类的，主要是考虑下自建，之前看到了自建的文章 |

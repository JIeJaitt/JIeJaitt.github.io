...
| 事件 | 进度 | 备注 |
| --- | --- | --- |
| wealth-app 中台下单：债券、公募、私募、票据、星财宝中台下单支持 | `doing` | 还剩一点点代码优化 |
| xjb-trade 星财宝专户回款 | `doing` | 明天必须自测结束，shouwcase掉 |
| 公司合作伙伴 | `wait` | 尽快开始，尽量三天做完 |
...
| 项目 | 简介 | 仓库 | 备注 |
| --- | --- | --- |--- |
| MYDB | 一个简单的数据库实现 | https://github.com/CN-GuoZiyang/MYDB | 适合Java新手玩家阅读的项目 |
